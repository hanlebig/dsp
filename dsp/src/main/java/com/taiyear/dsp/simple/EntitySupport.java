 ...
 * 
 */
package com.taiyear.dsp.simple;
...
public abstract class EntitySupport {
	 ...
	 */
	private StringBuffer getSupperClassFields(Class<?> clazz) throws IllegalArgumentException, IllegalAccessException {
	 ...
	 * @throws IllegalArgumentException
	 */
	private StringBuffer getClassFields(Class<?> clazz) throws IllegalArgumentException, IllegalAccessException {
